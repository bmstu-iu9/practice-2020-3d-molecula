//import ethanol from 'json_ethanol';
//let file = JSON.parse(benzene);
...
let atomList = parseAtoms(benzene);  // list of Atom objects
let bondList = parseBonds(benzene);  // list of Bond objects

let molecula2 = new Molecula(atomList, bondList); // Molecula object
