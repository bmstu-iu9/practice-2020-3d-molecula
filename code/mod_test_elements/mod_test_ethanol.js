//import ethanol from 'json_ethanol.js';
//let file = JSON.parse(ethanol);
...
let atomList = parseAtoms(ethanol);  // list of Atom objects
let bondList = parseBonds(ethanol);  // list of Bond objects

let molecula1 = new Molecula(atomList, bondList); // Molecula object
